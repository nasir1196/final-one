...
const Navbar = (request: NextRequest) => {
    ...
    const location = request.nextUrl.pathname

    const navigation = [
        location === "/home" ? {name: 'Home', to: '/home', current: true} : {name: 'Home', to: '/home', current: false},
        location === "/about" ? {name: 'About', to: '/about', current: true} : {
            name: 'About',
            to: '/about',
            current: false
        },
        location === "/project" ? {name: 'Projects', to: '/project', current: true} : {
            name: 'Projects',
            to: '/project',
            current: false
        },
        location === "/dashboard" ? {name: 'Dashboard', to: '/dashboard', current: true} : {
            name: 'Dashboard',
            to: '/dashboard',
            current: false
        },
